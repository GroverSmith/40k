...
class CrusadeDetails {
    ...
    async loadLeaderboard() {
        ...
        if (section) {
            ...
            try {
                ...
                const leaderboardHTML = this.buildLeaderboardHTML(leaderboardData, allForces);
                
                const content = CoreUtils.dom.getElement('leaderboard-content');
                if (content) {
                ...
                const content = CoreUtils.dom.getElement('leaderboard-content');
                if (content) {
                    content.innerHTML = '<div class="error-message">Failed to load leaderboard data.</div>';
                }
            }
        }
    }
    ...
    buildLeaderboardHTML(leaderboardData, allForces) {
